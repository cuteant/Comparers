...
{
    /// <summary>Common implementations for comparers that are based on a source comparer, possibly for a different type of object.</summary>
    ...
    internal abstract class SourceComparerBase<T, TSource> : ComparerBase<T>
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="SourceComparerBase&lt;T, TSource&gt;"/> class.</summary>
