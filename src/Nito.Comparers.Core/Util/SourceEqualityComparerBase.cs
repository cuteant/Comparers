...
{
    /// <summary>Common implementations for equality comparers that are based on a source comparer, possibly for a different type of object.</summary>
    ...
    {
        /// <summary>The source comparer.</summary>
        protected readonly IEqualityComparer<TSource> _source;

        /// <summary>Initializes a new instance of the <see cref="SourceEqualityComparerBase{T,TSource}"/> class.</summary>
