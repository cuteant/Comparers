...
{
    /// <summary>A comparer that performs a lexicographical ordering on a sequence.</summary>
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="SequenceEqualityComparer&lt;T&gt;"/> class.</summary>
