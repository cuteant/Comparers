...
{
    /// <summary>A comparer that works by comparing the results of the specified key selector.</summary>
    ...
    internal sealed class SelectComparer<T, TSource> : SourceComparerBase<T, TSource>
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="SelectComparer&lt;T, TSource&gt;"/> class.</summary>
