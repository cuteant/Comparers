...
namespace Nito.Comparers
{
    ...
    /// <summary>Provides sources for comparers, inferring the type being compared.</summary>
    public static class ComparerBuilder
    {
        /// <summary>Creates a source for a comparer of type <typeparamref name="T"/>.</summary>
        /// <typeparam name="T">The type of objects being compared.</typeparam>
